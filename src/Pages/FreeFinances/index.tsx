  ...
  return (
    <>
      ...
      <div className="freeFinances">
        <div className="infoFreeFinances">
            <h3>A sua escolha!</h3>
            <p>Agora você pode controlar a porcentagem de suas financas funamentais, pessoais e reservas de emergência</p>
        </div>

        <form onSubmit={enviarFreeFinances}>
          <span className="limite">{somas > 1 ? msgSomas : ""}</span>
